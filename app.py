...
@st.cache_resource
def load_model():
    return joblib.load("/content/drive/MyDrive/PGP AIML Certification Austin/7. Model Deployment/Week1 - Introduction to Model Deployment/deployment_files/rental_price_prediction_model_v1_0.joblib")
